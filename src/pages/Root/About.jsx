                    ...
                    <div className="flex flex-wrap ">
                            ...
                            <div className="relative lg:max-w-md">
                                ...
                                <div
                                    ...
                                    <p className="text-lg font-semibold md:w-72">
                                        ...
                                        </svg> Revolutionize Your Meetings with RapidLink
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
                            <div className="pl-4 mb-6 border-l-4 border-blue-500 ">
                                <span className="text-sm text-gray-600 uppercase mb-4">Who we are?</span>
                                <div className="relative">
                                    <h1 className="absolute -top-14 left-0 text-[120px] font-bold opacity-5 md:block hidden">
                                        ABOUT
                                    </h1>
                                    <h1 className="text-5xl font-bold"> About <span className="text-yellow-500"> Us
                                    </span> </h1>
