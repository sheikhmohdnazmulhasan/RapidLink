...
// MobileIconButton component that renders a button with optional badge, tooltip, and icon
export const MobileIconButton = ({
      ...
      // State variables for tracking mouse interaction and tooltip visibilit
      ...
      // Render the MobileIconButton component
      return (
            <>
                  {/* Button container with refs and mouse event handlers */}
                  <div ref={btnRef} onMouseEnter={openTooltip} onMouseLeave={closeTooltip}>
                        ...
                        >
                              {/* Button element with dynamic styling based on mouse interaction */}
                              <button
                              ...
                              >
                                    ...
                                    >
                                          ...
                                          {/* Display Lottie animation or regular icon based on lottieOption */}
                                          {lottieOption ? (
                                                <div
                  ...
                  {/* Tooltip element displayed below the button */}
                  <div
                        style={{ zIndex: 999 }}
